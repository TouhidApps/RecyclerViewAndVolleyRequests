...
public class MyRecyclerAdapterList extends RecyclerView.Adapter<MyRecyclerAdapterList.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener { // implements View.OnClickListener
        ...
        public TextView textViewTitle, textViewDetails;
    ...
    public MyRecyclerAdapterList(Context context, List<DemoDataModel> demoDataModels) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_demo_data_recycler_list, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.textViewDetails.setText(demoDataModel.getDetails());
